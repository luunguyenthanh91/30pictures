    ...
    <div class="page-content">
        <form method="post" action="">
            ...
            <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
                <h3>
                    <span class="hidden-320 ng-binding">Thay Đổi Thông Tin Nhân Viên</span>
                </h3>
                <div class="toolbar">
                                ...
                                <div class="tab-content">
                                    <div id="home" class="tab-pane fade in active row clearfix">
                                        <div class="col-lg-6 col-md-12 relative">
                                            <div class="form-group c_form_group ">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Họ Và Tên"
                                                        aria-label="Họ Và Tên" name="name" value="{{$user->name}}"
                                            ...
                                            <div class="form-group c_form_group ">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" placeholder="Mã Giới Thiệu"
                                                        aria-label="Nick Name" name="referrer_id"
                                                        value="{{$user->referrer_id}}" aria-describedby="basic-addon1">
                                                </div>
                                            </div>
                                            <div class="form-group c_form_group ">
                                                <label>Số Điện Thoại</label>
                                                <div class="input-group">
                                                    <input disabled type="text" class="form-control" placeholder="Số Điện Thoại"
                                            ...
                                            <div class="form-group c_form_group">
                                                ...
                                                <div class="input-group">
                                                    <input name="birthday" class="form-control birthday"
                                                        placeholder="Chọn Ngày" value="{{$user->birthday}}">
                                                </div>
                                            </div>
                                            <div class="form-group c_form_group">
                                            ...
                                            <div class="form-group c_form_group">
                                                ...
                                                <div class="input-group">
                                                    <select class="custom-select" name="notification">
                                                        <option value="1" @if($user->notification==1)
                                                            selected="selected" @endif>Mở
                                                        </option>
                                                        <option value="0" @if($user->notification==0)
                                                            selected="selected" @endif>Khóa
                                                        </option>
                                                    </select>
                                                </div>
                                    ...
                                    <div id="roles" class="tab-pane fade row clearfix">
                                        ...
                                        <div class="col-lg-2 col-md-6 relative">
                                            <div class="checkbox">
                                                <label>
                                                    <input name="role[{{$item->id}}]" @if($item->checked == 1) checked @endif type="checkbox" class="ace"
                                                        value="1" />
