        ...
        <div
            ...
            <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                ...
                <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                    <h1 class="h2 mb-0">List Customer</h1>
            ...
            <div class="row" role="tablist">
                <div class="col-auto">
                    <form action="" id="formUpload" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="file"  accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" name="sampledata" class="hidden" id="fileToUpload">
                        <button type="button" class="btn btn-outline-secondary upload-file">Import Customer</button>
                    </form>
                </div>
            </div>
        ...
        <div class="container page__container page-section">
            <div class="row mb-32pt">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary col-lg-12" type="button" @click="onSearch()">Search</button>
                    </div>
                </div>
                                ...
                                <table class="table mb-0 thead-border-top-0 table-nowrap">
                                    <tbody class="list" id="search">
                                        <tr v-for="item in list">
                                            <td>
                                                <p class="mb-2">
                                                    <a :href="'/admin/customer/edit/' + item.id" class="text-50">
...
new Vue({
    ...
    methods: {
        ...
        onLoadPagination() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{route('admin.getCustomer')}}?page=" + this.page + "&name=" + this.conditionName,
