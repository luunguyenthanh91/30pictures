        ...
        <div
            ...
            <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                ...
                <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                    <h1 class="h2 mb-0">Detail Vote</h1>

                    <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item"><a href="/admin">Home</a></li>
                        <li class="breadcrumb-item"><a href="/admin/list-vote">List Customer Vote</a></li>
                ...
                <div class="col-lg-8 d-flex align-items-center">
                    <div class="flex" style="max-width: 100%">
                        <form action="" method="POST" class="p-0 mx-auto">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="tenNganHang">{{$item->name}} : @if($item->type == 1) For @elseif($item->type == 2) Withheld @elseif($item->type == 3) Abstain @endif</label>
                            </div>
                            @endforeach
