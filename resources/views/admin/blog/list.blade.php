    ...
    <div id="list-data">
        <div
            ...
            <div class="row" role="tablist">
                <div class="col-auto">
                    <a href="/admin/blog/add" class="btn btn-outline-secondary">Thêm Mới</a>
                </div>
            </div>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <div class="flex title-edit mb-0  ">
                                                        ...
                                                        <p class="mb-0">((item.title))</p></a>
                                                    </div>
                                                    <div class="flex title-edit mb-0  ">
                                                        <a :href="'/admin/blog/edit/' + item.id" 
                                                            class="js-lists-values-employee-name">
                                                            <p class="mb-0" v-html="item.shor_title">((item.shor_title))</p>
                                                        </a>
                                                    </div>
...
new Vue({
    ...
    methods: {
        ...
        onLoadPagination() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{route('admin.getBlog')}}?page=" + this.page  + conditionSearch ,
