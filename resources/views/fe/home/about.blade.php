...
<meta charset="utf-8">
    ...
    <title>{{Helper::getSetting(1)->description}} - ABOUT US</title>
    <meta property="og:url" content="{{@url('/')}}">
    <meta property="og:type" content="website">
    <meta property="og:title" content="{{Helper::getSetting(1)->description}} - ABOUT US">
    ...
    <meta itemprop="name" content="{{Helper::getSetting(1)->description}} - ABOUT US">
    ...
    <meta name="twitter:title" content="{{Helper::getSetting(1)->description}} - ABOUT US">
    ...
    <meta name="keywords" content="{{Helper::getSetting(1)->description}} - ABOUT US">
    ...
    <div class="nk-wrap">
        <header>
            ...
            <div class="header_titleLogo">
                <a href="/index.html" class="titleLogo">
                    STORYSELLERS
                </a>
        ...
        <main style="background: black url({{@url(Helper::getSetting(9)->image_mobile)}}) center center no-repeat;webkit-background-size: cover;    background-size: cover;">
