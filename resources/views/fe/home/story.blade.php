...
<meta charset="utf-8">
    ...
    <title>{{Helper::getSetting(1)->description}} - STORY SELLERS</title>
    <meta property="og:url" content="{{@url('/')}}">
    <meta property="og:type" content="website">
    <meta property="og:title" content="{{Helper::getSetting(1)->description}} - STORY SELLERS">
    ...
    <meta itemprop="name" content="{{Helper::getSetting(1)->description}} - STORY SELLERS">
    ...
    <meta name="twitter:title" content="{{Helper::getSetting(1)->description}} - STORY SELLERS">
    ...
    <meta name="keywords" content="{{Helper::getSetting(1)->description}} - STORY SELLERS">
...
<body class="nk-body home_banner_video_crop_header">
    ...
    <div class="nk-wrap">
        <header>
            ...
            <div class="header_titleLogo">
                ...
                <p class="contentLogo">DIRECTOR NAME CARD</p>
            </div>
                    ...
                    <div class="mobile_style_slide">
                        <div class="owl-carousel owl-theme">
                            ...
                            @foreach($listStory as $item)
                                <div class="item">
                                    <a href="/director-{{$item->id}}.html" class="block-1 block">
                                        <img src="{{@url($item->image_mobile ? $item->image_mobile : '/')}}" class="bg" alt="{{$item->description}}" />
    ...
    <script src="{{ asset('fe/js/story.js') }}"></script>
    <script>
